	...
	return (
		<details>
			...
			<MainBodyText cssOverrides={mainBodyTextMarginTopStyles}>
				...
				can manage the use of cookies on our site for personalised advertising,
				and disable the sharing of data with partners for personalised
				advertising purposes by clicking the "Privacy settings" link in the
