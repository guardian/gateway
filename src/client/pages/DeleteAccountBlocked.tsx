	...
	return (
		<MinimalLayout
			...
			leadText={
				<>
					<MainBodyText>
						We&apos;ve noticed you have an active membership, recurring
						contribution or subscription with the Guardian, so you won&apos;t be
						able to automatically delete your account online.
					</MainBodyText>
					<MainBodyText>
						Please follow the instructions below first and try again if you
						would still like delete your account.
					</MainBodyText>
				</>
			}
		>
